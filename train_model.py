...
DEFAULT_STOCKS = "/content/gdrive/MyDrive/RL_projects/RL/Chapter08/data/ch08-small-quotes/YNDX_160101_161231.csv"
DEFAULT_VAL_STOCKS = "/content/gdrive/MyDrive/RL_projects/RL/Chapter08/data/ch08-small-quotes/YNDX_150101_151231.csv"
...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--run", default = "trial",  help="Run name")
    ...
    selector = ptan.actions.EpsilonGreedyActionSelector(EPSILON_START) #an array of size batch_size with random numbers 
    agent = ptan.agent.DQNAgent(net, selector, device=device)
    exp_source = ptan.experience.ExperienceSourceFirstLast(env, agent, GAMMA, steps_count=REWARD_STEPS)
    buffer = ptan.experience.ExperienceReplayBuffer(exp_source, REPLAY_SIZE) #add and replace if greater than REPLAY_SIZE
    ...
    with common.RewardTracker(writer, np.inf, group_rewards=100) as reward_tracker:
        while True:
            ...
            if len(buffer) < REPLAY_INITIAL: #until populated with minimum number of instances
                continue
